                            ...
                            storage
                                ...
                                .then((url) => {
                                    db.collection("posts").doc(doc.id).set(
                                        ...
                                        { merge: true } // This {merge: true} is importtant whenever we pass the set attribute because if we dont pass, the set part just post the image and we will loose the image we upladed before and will not show in the feed which we don't want to happen.
                                    );
                                });
                        }
                    );
